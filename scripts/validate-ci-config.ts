...
if (!/DATABASE_URL:\s*postgres:\/\/postgres:postgres@127\.0\.0\.1:5432\/brick_builder/iu.test(workflow)) throw new Error("Backend CI does not provide a runner-accessible PostgreSQL DATABASE_URL");
